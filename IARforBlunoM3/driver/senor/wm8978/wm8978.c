...
{
	//AT24CXX_Read(SYSTEM_PARA_SAVE_BASE+sizeof(_system_setings),(uint8_t*)wm8978dev,sizeof(_wm8978_obj));
}
//写入WM8978数据
//wm8978dev:wm8978数据
...
{										   
	...
	//AT24CXX_Write(SYSTEM_PARA_SAVE_BASE+sizeof(_system_setings),(uint8_t*)wm8978dev,sizeof(_wm8978_obj));
