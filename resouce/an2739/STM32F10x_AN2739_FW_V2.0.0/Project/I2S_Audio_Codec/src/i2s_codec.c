/**
  ******************************************************************************
  * @file I2S_Audio_Codec/src/i2s_codec.c 
...
__IO uint32_t AudioFileAddress = 0x64060000;
...
/**
  * @brief  Initializes the audio file parameters, the I2S peripheral and
  *   the audio codec according to parameters audio file parameters.
  * @param OutputDevice: Could be OutoutDevice_SPEAKER or
...
/**
  * @brief  Stop playing the audio file, reset the pointer and power off
  *   : the Codec.
  * @param  None
...
uint32_t I2S_CODEC_ControlVolume(uint32_t direction, uint8_t Volume)
{
  ...
  if (direction == VolumeDirection_HIGH)
  {
    ...
    {
      /* Save the new current volume level */
...
void I2S_CODEC_Mute(uint32_t Command)
{
  ...
  /* Read the current value of the Codec  register number 0x0E */
...
/**
  ...
  * @param Step: number of steps forward in percentage of the total stream.
  * @retval : None.
  */
...
/**
  ...
  * @param Step: number of steps back in percentage of the total stream.
  * @retval : None.
  */
...
/**
  ...
  * @param CodecPowerDown_Mode: could be CodecPowerDown_SW for softare
...
/**
  * @brief  Configure the Audio Codec output to Speaker or Headphone while
  ...
  * @retval : 
  *   - 0: Operation done without failures.
...
/**
  * @brief  Check if STOP or PAUSE command are generated and performs the
...
void I2S_CODEC_UpdateStatus(void)
{
  ...
  if ((GetVar_AudioPlayStatus() == AudioPlayStatus_STOPPED) && \
      (SPI_I2S_GetFlagStatus(SPI2, I2S_FLAG_CHSIDE) == SET))
  {
    I2S_CODEC_Stop();
  }
...
/**
  * @brief  returns DataStartAddr variable value (used by extern files).
  * @param  None
...
/**
  * @brief  returns AudioDataIndex variable value (used by extern files).
  * @param  None
  * @retval : AudioDataIndex
  */
...
/**
  * @brief  Sets AudioDataIndex variable value (used by extern files).
  * @param  None
  * @retval : AudioDataIndex
  */
...
/**
  * @brief  returns SendDummyData variable value (used by extern files).
  * @param  None
...
/**
  * @brief  Set the SendDummyData variable to 1 (enter Codec configuration phase).
  * @param  None
  * @retval : SendDummyData
  */
...
/**
  * @brief  Reset the SendDummyData variable to 0 (exit the Codec
  *   configuration phase).
  * @param  None
  * @retval : SendDummyData
  */
...
/**
  * @brief  returns AudioPlayStatus variable value (used by extern files).
  * @param  None
...
/**
  * @brief  Set the AudioPlayStatus variable to Status.
...
/**
  ...
  *         from zero (zero -> infinite replaying).
  * @param None.
  * @retval : AudioPlayStatus value.
  */
...
/**
  ...
  * @param  None
  * @retval : The current output device selected .
  */
...
/**
  ...
  * @param  None
  * @retval : The current audio file data length
  */
...
/**
  ...
  * @param  None
  * @retval : The current audio frequency
  */
...
/**
  ...
  * @arg I2S_Standard_MSB 
  * @arg I2S_Standard_LSB.
...
/**
  * @brief  Reads a number of bytes from the SPI Flash and reorder them
...
/**
  ...
  * @paramReadAddr: start reading position
...
/**
  * @brief  Sends the audio data using the SPI2 peripheral and checks the
